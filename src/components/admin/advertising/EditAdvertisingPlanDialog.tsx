...
export function EditAdvertisingPlanDialog({ plan, open, onOpenChange }: EditAdvertisingPlanDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Validate and convert empty string to 0 or 1 as needed
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Update the advertising plan details.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select
                value={formData.placement || 'basic'}
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                id="socialPromotion"
                checked={formData.socialPromotion || false}
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                checked={formData.newsletterFeature || false}
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                checked={formData.customIntegrations || false}
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => setFormData(prev => ({ ...prev, paypalPlanId: e.target.value }))}
                placeholder="P-..."
              />
            </div>
          </div>

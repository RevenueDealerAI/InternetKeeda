...
interface IPaymentSettings extends mongoose.Document {
  ...
  getCurrentStripeConfig(): Record<string, unknown>;
  getCurrentPayPalConfig(): Record<string, unknown>;
...
export const PaymentSettings = (mongoose.models.PaymentSettings as IPaymentSettingsModel) || mongoose.model<IPaymentSettings, IPaymentSettingsModel>('PaymentSettings', paymentSettingsSchema);

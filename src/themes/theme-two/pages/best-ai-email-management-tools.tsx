        ...
        >
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <div className="mt-8 text-sm text-blue-200 flex items-center">
              <div className="relative w-8 h-8 rounded-full overflow-hidden mr-2 border-2 border-blue-400"><Image src="https://ui-avatars.com/api/?name=Sarah+Wilson&background=3B82F6&color=fff" alt="Sarah Wilson" fill className="object-cover" unoptimized /></div>

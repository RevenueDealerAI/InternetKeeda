    ...
    <div className="space-y-2">
      ...
      <div className="relative">
        <Input
          ...
          className="pr-10 rounded-full focus:ring-2 focus:ring-purple-500 focus-visible:ring-2 focus-visible:ring-purple-500"
        />
        <button
          type="button"
      ...
      <Card className="rounded-2xl border shadow-sm">
        ...
        <CardContent>
          <Tabs defaultValue="stripe" className="space-y-6">
            <TabsList className="grid w-full grid-cols-3 rounded-full bg-purple-50 p-1">
              <TabsTrigger className="rounded-full data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-600 data-[state=active]:to-pink-500 data-[state=active]:text-white" value="stripe">Stripe</TabsTrigger>
              <TabsTrigger className="rounded-full data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-600 data-[state=active]:to-pink-500 data-[state=active]:text-white" value="paypal">PayPal</TabsTrigger>
              <TabsTrigger className="rounded-full data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-600 data-[state=active]:to-pink-500 data-[state=active]:text-white" value="general">General</TabsTrigger>
            </TabsList>
              ...
              {formData.stripe?.enabled && (
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    >
                      <SelectTrigger className="rounded-full focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 data-[state=open]:ring-2 data-[state=open]:ring-purple-500">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                      ...
                      <div className="space-y-4">
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            className="rounded-full focus:ring-2 focus:ring-purple-500 focus-visible:ring-2 focus-visible:ring-purple-500"
                          />
                        </div>
          ...
          <div className="flex justify-end pt-6 border-t">
            <Button
              ...
              className="min-w-[140px] rounded-full bg-gradient-to-r from-purple-600 to-pink-500 text-white hover:from-purple-700 hover:to-pink-600"
            >

...
export default function SiteSettingsPage() {
  ...
  return (
    <div className="theme-two space-y-6 space-y-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
        ...
        <Button
          ...
          variant="outline"
          size="sm"
          className="flex items-center gap-1 rounded-full w-full lg:w-auto justify-center"
          disabled={loading}
        >
      ...
      <Tabs defaultValue="general" className="space-y-6">
        <div className="overflow-x-auto pb-2 -mx-4 px-4 lg:mx-0 lg:px-0 lg:pb-0">
          <TabsList className="bg-purple-50 p-1 rounded-xl lg:rounded-full inline-flex w-auto lg:w-full lg:grid lg:grid-cols-7 h-auto lg:h-10">
            <TabsTrigger className="rounded-lg lg:rounded-full px-4 py-2 lg:px-3 lg:py-1 data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-600 data-[state=active]:to-pink-500 data-[state=active]:text-white whitespace-nowrap" value="general">General</TabsTrigger>
            <TabsTrigger className="rounded-lg lg:rounded-full px-4 py-2 lg:px-3 lg:py-1 data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-600 data-[state=active]:to-pink-500 data-[state=active]:text-white whitespace-nowrap" value="appearance">Appearance</TabsTrigger>
            <TabsTrigger className="rounded-lg lg:rounded-full px-4 py-2 lg:px-3 lg:py-1 data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-600 data-[state=active]:to-pink-500 data-[state=active]:text-white whitespace-nowrap" value="theme">Theme</TabsTrigger>
            <TabsTrigger className="rounded-lg lg:rounded-full px-4 py-2 lg:px-3 lg:py-1 data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-600 data-[state=active]:to-pink-500 data-[state=active]:text-white whitespace-nowrap" value="custom-code">Custom Code</TabsTrigger>
            <TabsTrigger className="rounded-lg lg:rounded-full px-4 py-2 lg:px-3 lg:py-1 data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-600 data-[state=active]:to-pink-500 data-[state=active]:text-white whitespace-nowrap" value="social">Social</TabsTrigger>
            <TabsTrigger className="rounded-lg lg:rounded-full px-4 py-2 lg:px-3 lg:py-1 data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-600 data-[state=active]:to-pink-500 data-[state=active]:text-white whitespace-nowrap" value="adsense">AdSense</TabsTrigger>
            <TabsTrigger className="rounded-lg lg:rounded-full px-4 py-2 lg:px-3 lg:py-1 data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-600 data-[state=active]:to-pink-500 data-[state=active]:text-white whitespace-nowrap" value="sitemap">Sitemap</TabsTrigger>
          </TabsList>
        </div>

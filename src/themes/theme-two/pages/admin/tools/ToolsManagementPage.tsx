          ...
          <div className="flex items-center gap-4 flex-1">
            <div className="relative max-w-md">
              ...
              <Input
                ...
                className="pl-9 rounded-full focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
              />
            ...
            <Select value={statusFilter} onValueChange={(value) => handleFilterChange('status', value)}>
              <SelectTrigger className="w-32 rounded-full focus-visible:ring-2 focus-visible:ring-purple-500">
            ...
            <Select value={sortBy} onValueChange={setSortBy}>
              <SelectTrigger className="w-36 rounded-full focus-visible:ring-2 focus-visible:ring-purple-500">
          ...
          <div className="h-[600px] overflow-y-scroll" style={{ scrollbarGutter: 'stable' }}>
            <Table>
              <TableHeader className="sticky top-0 bg-purple-50 z-10">
                <TableRow>
                  <TableHead className="text-purple-700 font-semibold">Tool</TableHead>
                  ...
                  <TableHead className="text-purple-700 font-semibold">Updated</TableHead>

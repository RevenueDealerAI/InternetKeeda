          ...
          <div className="h-[600px] overflow-y-scroll" style={{ scrollbarGutter: 'stable' }}>
            <Table>
              <TableHeader className="sticky top-0 bg-purple-50 z-10">
                <TableRow>
                  <TableHead className="text-purple-700 font-semibold">Icon</TableHead>
                  ...
                  <TableHead className="text-purple-700 font-semibold">Slug</TableHead>
                  <TableHead className="text-purple-700 font-semibold">Featured</TableHead>
                  <TableHead className="text-purple-700 font-semibold">Content</TableHead>

          ...
          <div className="flex items-center gap-4 flex-1 max-w-md">
            <div className="relative flex-1">
              ...
              <Input
                ...
                className="pl-9 rounded-full focus-visible:ring-2 focus-visible:ring-purple-500"
              />
            </div>
          </div>
          <Button
                      ...
                      <TableCell>
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem onSelect={() => handleDelete(post)}>
                              <Trash2 className="h-4 w-4 mr-2" />
                              Delete
                            </DropdownMenuItem>
                            <DropdownMenuItem onSelect={() => handleToggleStatus(post)}>

...
const AboutPage: React.FC = () => {
  ...
  const teamMembers = [
    {
      name: "John Smith",
      role: "Founder & CEO",
      image: "https://ui-avatars.com/api/?name=John+Smith&background=8039fd&color=fff",
    ...
    },
    {
      ...
      image: "https://ui-avatars.com/api/?name=Sarah+Johnson&background=8039fd&color=fff",
    ...
    },
    {
      name: "Michael Chen",
      role: "Lead Developer",
      image: "https://ui-avatars.com/api/?name=Michael+Chen&background=8039fd&color=fff",
  ...
  return (
    <div className="container mx-auto px-4 py-8 mt-24">
      ...
      >
        <motion.div variants={itemVariants} className="inline-flex items-center justify-center p-2 rounded-2xl bg-gradient-to-r from-purple-500/10 via-fuchsia-500/10 to-pink-500/10 backdrop-blur-sm mb-6">
          <div className="px-4 py-1 rounded-xl bg-gradient-to-r from-purple-600 to-pink-500">
      ...
      >
        <motion.div 
          variants={itemVariants}
          className="p-6 rounded-2xl bg-white border border-gray-200 shadow-lg hover:shadow-purple-100 transition-all duration-300"
        >
      ...
      >
        {[
          { icon: Sparkles, value: "1,000+", label: "AI Tools Listed", color: "purple" },
          { icon: Users, value: "50K+", label: "Community Members", color: "purple" },
          { icon: Star, value: "100K+", label: "Monthly Visits", color: "purple" },
          { icon: Heart, value: "10K+", label: "User Reviews", color: "purple" }
        ].map((stat, index) => (
          <motion.div
            key={index}
            variants={itemVariants}
            className="text-center p-6 rounded-2xl bg-white border border-gray-200 shadow-lg hover:shadow-purple-100 transition-all duration-300"
          >
            <div className={`h-12 w-12 rounded-2xl bg-${stat.color}-100 flex items-center justify-center mb-4 mx-auto`}>
              <stat.icon className={`h-6 w-6 text-${stat.color}-600`} />
            </div>
            <h4 className="text-2xl font-bold mb-1 bg-gradient-to-r from-purple-600 to-pink-500 bg-clip-text text-transparent">
              {stat.value}
            </h4>
      ...
      >
        <motion.h2 
          variants={itemVariants}
          className="text-3xl font-bold text-center mb-12 bg-gradient-to-r from-purple-600 to-pink-500 bg-clip-text text-transparent"
        >
          Meet Our Team
        </motion.h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {teamMembers.map((member, index) => (
            ...
            >
              <div className="relative w-24 h-24 rounded-full mx-auto mb-4 border-4 border-purple-100 overflow-hidden">
                <Image
                  src={member.image}
                  alt={member.name}
                  fill
      ...
      >
        <motion.div 
          variants={itemVariants}
          className="max-w-3xl mx-auto p-8 rounded-2xl bg-gradient-to-r from-purple-500/10 via-fuchsia-500/10 to-pink-500/10 backdrop-blur-sm"
        >

    ...
    <div className="relative">
      <div className="container mx-auto px-4 py-8 mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white rounded-2xl p-6 border border-gray-100 hover:border-purple-100 transition-all duration-300 hover:shadow-lg text-center">
            <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-purple-50 text-purple-500 mb-4">
              ...
              {plans.map((plan) => (
                <Card 
                  ...
                  className={`
                    ...
                    ${plan.isPopular 
                      ? 'border-purple-200 shadow-lg scale-105 bg-gradient-to-br from-purple-50 to-white' 
                      : 'border-gray-100 hover:border-purple-100 hover:shadow-lg'
                    }
                  `}
                >
                  {plan.isPopular && (
                  ...
                  <CardContent>
                    ...
                    <div className="space-y-3">
                      ...
                      {plan.paypalPlanId && (
                        <Button 
                          variant="outline"
                          className="w-full rounded-full border-2 border-purple-100 text-purple-600 hover:bg-purple-50"
                      ...
                      {!plan.stripePriceId && !plan.paypalPlanId && (
                        <Button 
                          className="w-full rounded-full bg-white border-2 border-purple-100 text-purple-600 hover:bg-purple-50"
      ...
      <div className="relative z-10 bg-gray-50 py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center bg-white rounded-2xl p-8 border border-gray-100 hover:border-purple-100 transition-all duration-300 hover:shadow-lg">
            ...
            <Button 
              className="bg-gradient-to-r from-purple-600 to-pink-600 text-white hover:from-purple-700 hover:to-pink-700 rounded-full px-8 py-6 h-auto font-medium text-base relative z-20"
              onClick={handleContactClick}
            >

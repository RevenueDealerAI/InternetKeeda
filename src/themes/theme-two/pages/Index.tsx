...
export default function Index() {
  ...
  // Generate categories from API + static + tools data
                  ...
                  >
                    <Link href={`/ai-tools/${tool.slug}`} className="group block h-full">
                      <article className="relative h-full p-[1px] rounded-[1.25rem] overflow-hidden transition-all duration-300 group hover:scale-[1.02] hover:shadow-xl" style={{
                        ...
                        {/* Content container */}
                        <div className="relative h-full bg-[#F5F5F5] rounded-[1.25rem] p-6 flex flex-col group-hover:bg-white transition-colors duration-300">
                          ...
                          <p className="text-base text-gray-600 mb-3 line-clamp-2 group-hover:text-gray-700 transition-all duration-500">
                            {tool.description}
                          </p>

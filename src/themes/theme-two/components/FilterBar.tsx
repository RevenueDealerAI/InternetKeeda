...
export function FilterBar({
  ...
  const shouldShowReset = useMemo(() => {
    return selectedCategory !== "all" || sortBy !== "trending" || !!searchQuery || (selectedPricing && selectedPricing !== "All") || !!selectedRating || !!selectedSpecialFilter;
  }, [selectedCategory, sortBy, searchQuery, selectedPricing, selectedRating, selectedSpecialFilter]);

  useEffect(() => {
    setShowReset(shouldShowReset);
  }, [shouldShowReset]);
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          ...
          <div className="flex-1 flex flex-col sm:flex-row items-start sm:items-center gap-3 w-full">
            ...
            <div 
              ...
              className="relative w-full sm:max-w-xs group cursor-pointer theme-two-search"
            >
              <div className="flex h-11 w-full items-center gap-2 rounded-xl border border-gray-200 bg-white px-3 py-2 text-sm ring-offset-white transition-all hover:border-purple-500/50 group-hover:shadow-sm">
            ...
            <Popover open={categoryOpen} onOpenChange={setCategoryOpen}>
              <PopoverTrigger asChild>
                <Button
                  ...
                  className="justify-between w-full sm:w-auto bg-white border-gray-200 hover:bg-gray-50 hover:border-purple-500/50 hover:text-purple-700 h-11"
                >
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            ...
            <Button
              ...
              variant="outline"
              className={cn(
                "h-11 bg-white border-gray-200 hover:bg-gray-50 hover:border-purple-500/50 hover:text-purple-700",
                showAdvancedFilters && "bg-purple-50 text-purple-700 border-purple-200"
              )}
            >
            ...
            <div className="flex items-center gap-2">
              <Button 
                ...
                className={`h-11 w-11 border ${viewMode === 'grid' 
              ...
              <Button 
                ...
                className={`h-11 w-11 border ${viewMode === 'list' 
                  ? 'bg-purple-100 text-purple-700 border-purple-300' 
                  : 'bg-white border-gray-200 hover:bg-gray-50'}`}
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {["All", "Free", "Freemium", "Paid"].map((option) => (
                    <Badge
                      ...
                      className={cn(
                      "cursor-pointer hover:bg-purple-50 h-8",
                      (selectedPricing || "All") === option 
                        ? "bg-purple-100 text-purple-700 hover:bg-purple-200 border-purple-200" 
                        : "text-gray-700 hover:text-purple-700 border-gray-200"
                      )}
                  ...
                  <Badge
                    ...
                    className={cn(
                      "cursor-pointer h-8",
                        ...
                        : "bg-white text-gray-700 hover:bg-purple-50 hover:text-purple-700 border-gray-200"
                    )}
          ...
          {showReset && (
            <div className="flex items-center gap-2 ml-2">
              {selectedCategory !== "all" && (
                <Badge 
                  variant="secondary" 
                  className="px-2 py-0 h-6 bg-purple-50 hover:bg-purple-100 gap-1.5 group"
                >
                  <span>{categories.find(c => c.value === selectedCategory)?.label}</span>
                  <X 
                    className="h-3 w-3 text-gray-500 group-hover:text-purple-700" 
                    onClick={(e) => {
                      e.stopPropagation();
                      onCategoryChange("all");
                    }}
              ...
              <Button 
                ...
                className="h-6 px-2.5 text-purple-600 hover:text-purple-700 hover:bg-purple-50"
              >
                Reset all
              </Button>
            </div>

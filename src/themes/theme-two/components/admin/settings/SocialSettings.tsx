      ...
      <div className="pt-4 border-t">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            className="rounded-full focus-visible:ring-2 focus-visible:ring-purple-500"
          />
          <p className="text-xs text-muted-foreground">Your Google Analytics measurement ID (starts with G-)</p>
        </div>
      </div>

      <Button type="submit" disabled={saving} className="mt-6 rounded-full bg-gradient-to-r from-purple-600 to-pink-500 text-white hover:from-purple-700 hover:to-pink-600">

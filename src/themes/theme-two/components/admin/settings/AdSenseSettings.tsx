                ...
                <div className="flex flex-col md:flex-row gap-3 mb-4 w-full">
                  <div className="w-full md:flex-1">
                    <Input
                      ...
                      className="w-full rounded-full focus-visible:ring-2 focus-visible:ring-purple-500"
                    />
                  </div>
                  <div className="flex gap-2 w-full md:w-auto">
                      ...
                      >
                        ...
                        <SelectContent>
                          {AD_POSITIONS.map((pos) => (
                            <SelectItem key={pos.value} value={pos.value} className="focus:bg-purple-50 focus:text-purple-700 data-[highlighted]:bg-purple-50 data-[highlighted]:text-purple-700">
                              {pos.label}
                            </SelectItem>
                          ))}
                        </SelectContent>
                    ...
                    <Button
                      ...
                      className="flex-shrink-0 rounded-full bg-gradient-to-r from-purple-600 to-pink-500 text-white hover:from-purple-700 hover:to-pink-600"
                    >

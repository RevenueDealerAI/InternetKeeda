          ...
          <div className="bg-white/90 shadow-sm backdrop-blur-sm rounded-xl p-2 w-10 h-10 flex items-center justify-center relative">
            <Image
              ...
              onError={(e) => {
                const target = e.target as HTMLImageElement;
                target.onerror = null;
                target.src = `https://ui-avatars.com/api/?name=GitHub&background=6366f1&color=fff&bold=true&format=svg`;
              }}
            />
          </div>
        </div>
          ...
          <div className="bg-white/90 shadow-sm backdrop-blur-sm rounded-xl p-2 w-10 h-10 flex items-center justify-center relative">
            <Image
              ...
              onError={(e) => {
                const target = e.target as HTMLImageElement;
                target.onerror = null;
                target.src = `https://ui-avatars.com/api/?name=OpenAI&background=6366f1&color=fff&bold=true&format=svg`;
              }}
            />
          </div>
        </div>

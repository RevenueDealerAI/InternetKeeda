    ...
    return (
      <div className="rounded-md bg-green-50 p-4 dark:bg-green-900">
        ...
        <button
          ...
          className="mt-2 rounded-full bg-purple-100 px-4 py-2 text-sm font-medium text-purple-800 hover:bg-purple-200"
        >
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        <button
          ...
          className="rounded-full px-6 py-3 text-sm font-medium text-white hover:shadow-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-70"
        >

        ...
        >
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <div className="mt-8 text-sm text-orange-200 flex items-center">
              <div className="relative w-8 h-8 rounded-full overflow-hidden mr-2 border-2 border-orange-400"><Image src="https://ui-avatars.com/api/?name=Jennifer+Martinez&background=F97316&color=fff" alt="Jennifer Martinez" fill className="object-cover" unoptimized /></div>
          ...
          {toolsList.map((tool, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-4 border-b border-gray-100 p-6 bg-white">
                <div className="w-14 h-14 bg-white rounded-lg flex items-center justify-center shadow-sm overflow-hidden border border-gray-100 relative">
                  <Image 
                    src={tool.logo} 
                    alt={tool.name} 
                    fill

...
const GuidesPage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 mt-24">
      ...
      >
        <motion.div variants={itemVariants} className="inline-flex items-center justify-center p-2 rounded-2xl bg-gradient-to-r from-orange-500/10 via-fuchsia-500/10 to-blue-500/10 backdrop-blur-sm mb-6">
          <div className="px-4 py-1 rounded-xl bg-gradient-to-r from-orange-500 via-fuchsia-500 to-blue-600">
            <span className="text-white font-medium">AI-Hunt Guides</span>
          </div>
        </motion.div>
        <motion.h1 
          variants={itemVariants}
          className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-orange-600 via-fuchsia-500 to-blue-600 bg-clip-text text-transparent"
        >
      ...
      >
        <motion.div
          variants={itemVariants}
          className="p-8 rounded-2xl bg-gradient-to-r from-orange-500/10 via-fuchsia-500/10 to-blue-500/10 backdrop-blur-sm border border-gray-200/50"
        >
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <Button className="bg-gradient-to-r from-orange-600 to-blue-600 text-white">
                Read Guide
      ...
      >
        ...
        >
          ...
          <Button className="bg-gradient-to-r from-orange-600 to-blue-600 text-white hover:from-orange-700 hover:to-blue-700">
            Join Community
            <ArrowRight className="ml-2 h-4 w-4" />
          </Button>
        </motion.div>

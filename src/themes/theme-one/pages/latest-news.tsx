...
const SAMPLE_REVIEWS: NewsPost[] = [
  ...
  {
    _id: 'sample-jobscan',
    title: 'Jobscan — narrow, accurate, and slightly overpriced ATS keyword diffing',
  ...
  {
    _id: 'sample-apify',
    title: 'Apify — the AWS Lambda of web scraping, billed by the compute-second',
  ...
  {
    _id: 'sample-hostinger',
    title: 'Hostinger — budget hosting that actually performs, until the renewal lands',

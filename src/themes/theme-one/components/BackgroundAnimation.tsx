  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-1/4 left-1/4 w-32 h-px bg-gradient-to-r from-transparent via-orange-500/30 to-transparent animate-pulse" style={{ animationDelay: '0s' }} />
      ...
      {/* Floating Particles */}
      <div className="absolute inset-0">
        <div className="absolute top-1/4 left-1/4 w-1 h-1 rounded-full bg-orange-500/30 animate-float" style={{ animationDelay: '0s' }} />
